...
namespace FinalProject.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MessageId,MessageText,ManagerId,TenantId")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MessageId,MessageText,ManagerId,TenantId")] Message message)
        {
            if (ModelState.IsValid)
            {
